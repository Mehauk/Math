...
> - [Linear Algebra](#linear-algebra)
 ...
 ## Neural Network
  ...
  Taking a look at the neural nework above we can see that with only one weight and one bias we can only construct relationships that look like $f(x) = wx + b$. 
