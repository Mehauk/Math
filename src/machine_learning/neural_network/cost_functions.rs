...
impl CostFunction {
    pub fn calc_cost(&self) -> fn(&Matrix, &Matrix) -> Matrix {
        self.cost
    }

    pub fn derive(&self) -> fn(&Matrix, &Matrix) -> Matrix {
        self.derivative
    }
}
...
/// - `R - E` Difference of actual result verses expected
fn quadratic_cost_derivative(r: &Matrix, e: &Matrix) -> Matrix {} // DO stuff here
